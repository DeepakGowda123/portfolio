...
const projects = [
  {
    ...
    emoji: "🧠",
    description:
      "Full-stack ML-powered Android app for ADHD subtype prediction and adaptive focus tracking.",
  ...
  {
    id: "realtime-tictactoe",
    title: "Real-Time Multiplayer Tic-Tac-Toe",
    tagline: "WebSocket-Based Gaming Engine",
    emoji: "🎮",
    description:
      "Full-stack multiplayer Tic-Tac-Toe game with real-time synchronization, bot mode, and live leaderboard.",
    tech: ["Java", "Spring Boot", "WebSocket", "STOMP", "React.js"],
    highlights: [
      "Built Java Spring Boot WebSocket (STOMP) backend for instant bidirectional gameplay updates",
      "Designed thread-safe session engine using ConcurrentHashMap and synchronized logic",
      "Developed React UI with SockJS/StompJS, bot mode, restart flow, and REST-based leaderboard"
    ],
    architecture: [
      "React Client",
...

  {
    ...
    emoji: "🌾",
    description:
      "Full-stack mobile marketplace connecting farmers, vendors, and laborers with secure payments.",
...

  {
    ...
    emoji: "🛡️",
    description:
      "Hackathon project filtering emotionally manipulative advertisements using AI-powered detection.",
  ...
  return (
    <section id="projects" className="py-20 px-4 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {projects.map((project, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 opacity-0 group-hover:opacity-5 transition-opacity duration-300 bg-gradient-to-br ${project.gradient}`}
                />
                ...
                <div className="relative z-10 mt-8">
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`p-3 rounded-xl bg-gradient-to-br ${project.gradient} shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                    >
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-2 h-2 rounded-full ${
                          isSelected ? "bg-green-500 animate-pulse" : "bg-muted-foreground/30"
                        }`}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <p className="text-xs text-muted-foreground font-mono">{project.tagline}</p>
                  </div>
        ...
        <div
          className="mt-12 p-6 rounded-xl border-2 border-border bg-card/50 backdrop-blur-sm font-mono text-sm animate-fade-in"
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground text-xs">
                <span className="text-primary">&#123;</span> "projects": 4, "status": "success",
                "message": "All systems deployed and operational"
